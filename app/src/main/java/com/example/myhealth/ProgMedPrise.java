...
public class ProgMedPrise extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_prog_med_prise);
    Intent i = getIntent();
    final int idx = i.getIntExtra(ProgGestP.id2, 0);
    if (idx!=0){
      q=idx;}
    final int idp = i.getIntExtra(ProgMed.id1, 0);
    if (idp!=0){
      p=idp;}
    sm= (Button)findViewById(R.id.smed);
    sm.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        dbHelper.Deleteprogrammed(p,q);
        Intent in  = new Intent(ProgMedPrise.this,ProgMed.class);
    ...
    addpr= (Button)findViewById(R.id.bottomp);
    addpr.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent in  = new Intent(ProgMedPrise.this,AddMedPriss.class);
        in.putExtra(id1,p);
