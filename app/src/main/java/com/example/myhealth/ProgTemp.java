...
public class ProgTemp extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_prog_temp);
    Intent i = getIntent();
    ...
    if (id!=0){
      p=id;}
    addt=(Button)findViewById(R.id.addtmp);
    addt.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent in  = new Intent(ProgTemp.this,AddPT.class);
        in.putExtra(id1,p);
